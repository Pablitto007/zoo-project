...
public class AnimalRestControllerTest {
    ...
    public void findOneTest_Success() throws Exception{
    	...
    	when(animalRepositoryMock.findOne(1L)).thenReturn(optional);
    	...
    	verify(animalRepositoryMock, times(1)).findOne(1L);
    	verifyNoMoreInteractions(animalRepositoryMock);
    }
    
    @Test
    public void findOneTest_NotFound() throws Exception{
    	when(animalRepositoryMock.findOne(1L)).thenThrow(new DataAccessResourceFailureException(""));
